...
<div class="body-wrapper">
    <div class="container-fluid">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card overflow-hidden">
                            <div class="card-body p-4">
                                <h5 class="card-title mb-9 fw-semibold">Keuntungan Pertahun</h5>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row alig n-items-start">
                                    <div class="col-8">
                                        <h5 class="card-title mb-9 fw-semibold"> Keuntungan Perbulan </h5>
        ...
        <div class="row">
            <div class="col-lg-4 d-flex align-items-stretch">
                <div class="card w-100">
                    <div class="card-body p-4">
                        <div class="mb-4">
                            <h5 class="card-title fw-semibold">Aktifitas Terbaru</h5>
                        </div>
        ...
        <div class="row">
            <h5 class="card-title fw-semibold mb-4">Produk Terlaris</h5>
